...
\begin{figure*}[b]
    \centering
    \fullfig{../../Rss/QM/Chapter/PhotoElec.png}
...
We begin by considering the particle as a wave, in particular a standing wave, which have boundaries condition of zero at both side.
This boundaries condition imply the quantized wavelength and wave number
\begin{equation*}
    \lambda=\frac{2\pi L }{n}\qquad k=\frac{n\pi }{L}
\end{equation*}
With the de Broglie relation $p=h/\lambda=\hbar k$, we write the energies of the particles, which only consist of kinetic energy, as 
\begin{equation*}
    T=\frac{p^2 }{2m }=\frac{\hbar^2 k^2 }{2m}=\frac{\hbar^2n^2\pi^2}{2mL^2}
\end{equation*}
with $L$ as the length of the potential well, not angular momentum.
